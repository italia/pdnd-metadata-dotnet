    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          build: { description: 'Changes that affect the build system', title: 'Builds', emoji: '🛠' },
          ci: { description: 'Changes to CI configuration', title: 'Continuous Integrations', emoji: '⚙️' },
